      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <Card data-testid="profit-card" className="bg-white/90 backdrop-blur border-slate-200 hover:shadow-xl transition-all duration-300">
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <CardTitle className="text-lg font-semibold text-slate-700">Realized Profit</CardTitle>
                <TrendingUp className="w-5 h-5 text-purple-600" />
              </div>
            </CardHeader>
            <CardContent>
              <p className="text-3xl font-bold text-slate-600" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                ₹0.00
              </p>
              <p className="text-sm text-slate-500 mt-1">Only from closed positions</p>
              <p className="text-xs text-amber-600 mt-1">⚠️ Profit tracking will be calculated when positions are fully closed (Buy+Sell matched)</p>
            </CardContent>
          </Card>
